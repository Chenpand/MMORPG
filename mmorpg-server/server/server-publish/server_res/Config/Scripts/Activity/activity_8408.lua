...
function AddReward(player)
	...
	local giftpack = {}
		if job == 5 then
			...
			item2 = {id=330000001,num=120}, item3 = {id=200110002,num=200},
			item4 = {id=600000007,num=500000}, item5 = {id=200000310,num=1}}		
		elseif job == 1 then
			giftpack = {item1 = {id=200000312,num=1}, 
			item2 = {id=330000001,num=120}, item3 = {id=200110002,num=200},
			item4 = {id=600000007,num=500000}, item5 = {id=200000310,num=1}}
		...
		player:AddRewards("16003;8408;0", group, true)
		return true
end