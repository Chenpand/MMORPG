...
function AddReward(player)
	...
	local giftpack = {}
		if job == 5 then
			giftpack = {item1 = {id=200000310,num=1}, 
			item2 = {id=330000001,num=30}, item3 = {id=200000002,num=100},
			item4 = {id=300000106,num=500}, item5 = {id=810000009,num=1}}		
		elseif job == 1 then
			giftpack = {item1 = {id=200000310,num=1}, 
			item2 = {id=330000001,num=30}, item3 = {id=200000002,num=100},
			item4 = {id=300000106,num=500}, item5 = {id=810000009,num=1}}
		...
		player:AddRewards("16003;8404;0", group, true)
		return true
end