...
function AddReward(player)
	...
	local giftpack = {}
		if job == 5 then
			giftpack = {item1 = {id=330000001,num=30}, 
			item2 = {id=200000002,num=100},item3 = {id=535003006,num=1},
			item4 = {id=200110002,num=100}}		
		elseif job == 1 then
			giftpack = {item1 = {id=330000001,num=30}, 
			item2 = {id=200000002,num=100},item3 = {id=531003006,num=1},
			item4 = {id=200110002,num=100}}
		elseif job == 3 then
			giftpack = {item1 = {id=330000001,num=30}, 
			item2 = {id=200000002,num=100},item3 = {id=533003006,num=1},
			item4 = {id=200110002,num=100}}		
		elseif job == 2 then
			giftpack = {item1 = {id=330000001,num=30}, 
			item2 = {id=200000002,num=100},item3 = {id=532003006,num=1},
			item4 = {id=200110002,num=100}}
		end
		...
		player:AddRewards("16003;8405;0", group, true)
		return true
end