...
function AddReward(player)
	...
	local giftpack = {}
		if job == 5 then
			giftpack = {item1 = {id=200000310,num=5}, 
			item2 = {id=200000317,num=1}, item3 = {id=300000105,num=1000},
			item4 = {id=600000007,num=1000000}, item5 = {id=300000106,num=1000}}		
		elseif job == 1 then
			giftpack = {item1 = {id=200000310,num=5}, 
			item2 = {id=200000317,num=1}, item3 = {id=300000105,num=1000},
			item4 = {id=600000007,num=1000000}, item5 = {id=300000106,num=1000}}
		...
		player:AddRewards("16003;8410;0", group, true)
		return true
end