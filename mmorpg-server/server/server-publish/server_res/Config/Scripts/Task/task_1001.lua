function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(0, 602000)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(0, 602001)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(0, 602002)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(0, 602003)	 -- 关注杀死指定怪物事件
end
