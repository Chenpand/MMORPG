function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(139, 506030)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(139, 506031)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(139, 506032)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(139, 506033)	 -- 关注杀死指定怪物事件
