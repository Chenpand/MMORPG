function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(118, 502030)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(118, 502031)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(118, 502032)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(118, 502033)	 -- 关注杀死指定怪物事件
