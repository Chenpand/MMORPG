function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(0, 206000)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(0, 206001)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(0, 206002)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(0, 206003)	 -- 关注杀死指定怪物事件
end
