function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(118, 502000)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(118, 502001)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(118, 502002)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(118, 502003)	 -- 关注杀死指定怪物事件
