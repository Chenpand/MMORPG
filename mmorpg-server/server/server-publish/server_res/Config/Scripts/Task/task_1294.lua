function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(120, 504000)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(120, 504001)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(120, 504002)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(120, 504003)	 -- 关注杀死指定怪物事件
