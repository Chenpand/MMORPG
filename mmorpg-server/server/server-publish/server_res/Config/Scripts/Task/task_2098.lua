function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(117, 503030)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(117, 503031)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(117, 503032)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(117, 503033)	 -- 关注杀死指定怪物事件
