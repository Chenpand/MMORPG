function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(122, 505000)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(122, 505001)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(122, 505002)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(122, 505003)	 -- 关注杀死指定怪物事件
