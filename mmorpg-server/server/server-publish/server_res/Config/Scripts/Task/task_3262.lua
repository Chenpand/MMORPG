function Init(task)				---°ó¶¨(×¢²á)¸ÃÈÎÎñÐèÒª¹Ø×¢µÄÊÂ¼þ
    task:BindClearDungeonEvent(205002, 3)	-- ¹Ø×¢Í¨¹ØÄ³¸öµØÏÂ³ÇÊÂ¼þ£¨µØÏÂ³Ç£¬ÆÀ¼Û£¬Ê±¼ä/ºÁÃë£©
    task:BindClearDungeonEvent(205003, 3)	-- ¹Ø×¢Í¨¹ØÄ³¸öµØÏÂ³ÇÊÂ¼þ£¨µØÏÂ³Ç£¬ÆÀ¼Û£¬Ê±¼ä/ºÁÃë£©
end
