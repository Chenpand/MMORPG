function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(0, 205000)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(0, 205001)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(0, 205002)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(0, 205003)	 -- 关注杀死指定怪物事件
end
