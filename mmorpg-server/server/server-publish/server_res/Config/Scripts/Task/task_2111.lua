function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(127, 506010)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(127, 506011)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(127, 506012)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(127, 506013)	 -- 关注杀死指定怪物事件
