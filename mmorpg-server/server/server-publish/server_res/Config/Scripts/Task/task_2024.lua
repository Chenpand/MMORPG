function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(146, 205020)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(146, 205021)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(146, 205022)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(146, 205023)	 -- 关注杀死指定怪物事件
