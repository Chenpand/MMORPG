function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(117, 503000)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(117, 503001)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(117, 503002)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(117, 503003)	 -- 关注杀死指定怪物事件
