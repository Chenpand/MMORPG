...
{
	//make environment
	void	make_env(lua_State *L, const char* env, const char* sendbox_func);

	void push_meta(lua_State *L, const char* name);

	// excution
	bool	dofile(lua_State *L, const char *filename, const char* env = NULL);
	...
	struct mem_var : var_base
	{
		...
		void get(lua_State *L)	{
			T* obj = read<T*>(L, 1); 
			if (!obj) {
				print_error(L, "lua_tinker get mem_var obj is null");
				return;
			}
			push(L, obj->*(_var));
		}
		void set(lua_State *L)	{ 
			T* obj = read<T*>(L, 1);
			if (!obj) {
				print_error(L, "lua_tinker set mem_var obj is null");
				return;
			}
			obj->*(_var) = read<V>(L, 3);
		}
	...
	struct mem_functor
	{
		static int invoke(lua_State *L) { 
			T* obj = read<T*>(L, 1);
			if (!obj) {
				print_error(L, "lua_tinker invoke mem_func obj is null");
				return -1;
			}
			push(L,(obj->*upvalue_<RVal(T::*)(T1,T2,T3,T4,T5,T6)>(L))(read<T1>(L,2),read<T2>(L,3),read<T3>(L,4),read<T4>(L,5),read<T5>(L,6),read<T6>(L,7)));
			return 1; 
		}
	};
	...
	struct mem_functor<RVal,T,T1,T2,T3,T4,T5>
	{
		static int invoke(lua_State *L) {
			...
			push(L, (obj->*upvalue_<RVal(T::*)(T1,T2,T3,T4,T5)>(L))(read<T1>(L,2),read<T2>(L,3),read<T3>(L,4),read<T4>(L,5),read<T5>(L,6)));
			return 1;
		}
	};
	...
	struct mem_functor<RVal,T,T1,T2,T3,T4>
	{
		static int invoke(lua_State *L) { 
			...
			push(L,(obj->*upvalue_<RVal(T::*)(T1,T2,T3,T4)>(L))(read<T1>(L,2),read<T2>(L,3),read<T3>(L,4),read<T4>(L,5))); 
			return 1;
		}
	};
	...
	struct mem_functor<RVal,T,T1,T2,T3>
	{
		static int invoke(lua_State *L) { 
			...
			push(L,(obj->*upvalue_<RVal(T::*)(T1,T2,T3)>(L))(read<T1>(L,2),read<T2>(L,3),read<T3>(L,4))); 
			return 1; 
		}
	};
	...
	struct mem_functor<RVal,T,T1, T2>
	{
		static int invoke(lua_State *L) { 
			...
			push(L,(obj->*upvalue_<RVal(T::*)(T1,T2)>(L))(read<T1>(L,2),read<T2>(L,3))); return 1;
		}
	};
	...
	struct mem_functor<RVal,T,T1>
	{
		static int invoke(lua_State *L) { 
			...
			push(L,(obj->*upvalue_<RVal(T::*)(T1)>(L))(read<T1>(L,2))); 
			return 1;
		}
	};
	...
	struct mem_functor<void, T, T1, T2, T3, T4, T5, T6>
	{
		static int invoke(lua_State *L) {
			...
			(obj->*upvalue_<void(T::*)(T1, T2, T3, T4, T5, T6)>(L))(read<T1>(L, 2), read<T2>(L, 3), read<T3>(L, 4), read<T4>(L, 5), read<T5>(L, 6), read<T6>(L, 7));
			return 0;
		}
	};
	...
	struct mem_functor<void,T,T1,T2,T3,T4,T5>
	{
		static int invoke(lua_State *L)  { 
			...
			(obj->*upvalue_<void(T::*)(T1,T2,T3,T4,T5)>(L))(read<T1>(L,2),read<T2>(L,3),read<T3>(L,4),read<T4>(L,5),read<T5>(L,6));
			return 0; 
		}
	};
	...
	struct mem_functor<void,T,T1,T2,T3,T4>
	{
		static int invoke(lua_State *L)  { 
			...
			(obj->*upvalue_<void(T::*)(T1,T2,T3,T4)>(L))(read<T1>(L,2),read<T2>(L,3),read<T3>(L,4),read<T4>(L,5)); 
			return 0; 
		}
	};
	...
	struct mem_functor<void,T,T1,T2,T3>
	{
		static int invoke(lua_State *L)  { 
			...
			(obj->*upvalue_<void(T::*)(T1,T2,T3)>(L))(read<T1>(L,2),read<T2>(L,3),read<T3>(L,4)); 
			return 0; 
		}
	};
	...
	struct mem_functor<void,T,T1,T2>
	{
		static int invoke(lua_State *L)  { 
			...
			(obj->*upvalue_<void(T::*)(T1,T2)>(L))(read<T1>(L,2),read<T2>(L,3)); 
			return 0; 
		}
	};
	...
	struct mem_functor<void,T,T1>
	{
		static int invoke(lua_State *L)  { 
			...
			(obj->*upvalue_<void(T::*)(T1)>(L))(read<T1>(L,2));
			return 0; 
		}
	};
	...
	// call
	template<typename RVal>
	RVal call(lua_State* L, const char* env, const char* name)
	{
		LuaStackGuard sg(L);
		...
		if(env != NULL)
		{
			...
			{
				print_error(L, "lua_tinker::call() attempt to use `%s' (not an env)", env);
				lua_remove(L, -2);
				return pop<RVal>(L);
			}
		}
	...
	template<typename RVal, typename T1>
	RVal call(lua_State* L, const char* env, const char* name, T1 arg)
	{
		LuaStackGuard sg(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	template<typename RVal, typename T1, typename T2>
	RVal call(lua_State* L, const char* env, const char* name, T1 arg1, T2 arg2)
	{
		LuaStackGuard sg(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	template<typename RVal, typename T1, typename T2, typename T3>
	RVal call(lua_State* L, const char* env, const char* name, T1 arg1, T2 arg2, T3 arg3)
	{
		LuaStackGuard sg(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	template<typename RVal, typename T1, typename T2, typename T3, typename T4>
	RVal call(lua_State* L, const char* env, const char* name, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
	{
		LuaStackGuard sg(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	template<typename RVal, typename T1, typename T2, typename T3, typename T4, typename T5>
	RVal call(lua_State* L, const char* env, const char* name, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
	{
		LuaStackGuard sg(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	struct class_name
	{
		...
		static const char* name(const char* name = NULL)
		{
			...
			if(name) avalon_strncpy(temp, name, 256);
			return temp;
		}
	};
	...
	struct table_visitor
	{
		virtual ~table_visitor(){}
		virtual bool operator()(KeyT key, ValueT value) = 0;
	};
	...
	struct table_obj
	{
		...
		//visit
		template<typename KeyT, typename ValueT>
		void visit(table_visitor<KeyT, ValueT>& visitor)
		{
			if (validate())
			{
				lua_pushnil(m_L);
				...
				{
					bool ret = visitor(read<KeyT>(m_L,-2), read<ValueT>(m_L,-1));
					lua_pop(m_L,1);
					if(!ret){
						lua_pop(m_L,1);
						return;
