...
public:
	...
	SkillMgr& GetSkillMgr(){ return m_SkillMgr; }
...
public:	//编码解码相关
	...
	CL_SYNC_PROPERTY(m_BuffMgr, SOA_BUFFS, SST_SELF | SST_SELECTED | SST_TEAM | SST_SKILLBUFF | SST_AROUND | SST_TEST)
