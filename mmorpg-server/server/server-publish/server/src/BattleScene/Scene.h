...
public:
	 ...
	 *@brief 获取配置项
	 */
	void SetDataEntry(SceneDataEntry* data) { m_pDataEntry = data; }
...
public://城镇怪物相关
	...
	*/
	CityMonster* SummonCityMonster(ObjID_t guid, ObjID_t owner, const std::string& name,
		...
		UInt32 battleId = 0, UInt32 battleDyncSceneId = 0, UInt32 reviveTimeSpace = 0);
...
public://访问接口
    ...
    */
	...
	virtual UInt32 BattlePlayerNum() { return 0; }
public://消息相关
	/**
	 *@brief 广播到场景所有玩家
	 */
...
protected:
	...
	// 等待玩家退出定时器
	Avalon::SimpleTimer m_WaitPlayerQuitTimer;
