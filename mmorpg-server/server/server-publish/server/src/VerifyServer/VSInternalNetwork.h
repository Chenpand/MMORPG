#ifndef __VS_INTERNAL_NETWORK_H__
#define __VS_INTERNAL_NETWORK_H__
...
*@brief 内网
*/
class VSInternalNetwork : public CLInternalNetwork, public Avalon::Singleton<VSInternalNetwork>
{
public:
	VSInternalNetwork();
	~VSInternalNetwork();
