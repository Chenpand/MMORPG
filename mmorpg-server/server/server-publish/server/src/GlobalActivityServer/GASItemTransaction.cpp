...
GASItemTransaction::GASItemTransaction(GASPlayer* player)
	:m_pPlayer(player)
{
...
GASItemTransaction::~GASItemTransaction()
{
}

void GASItemTransaction::SetItem(UInt32 id, UInt32 num, UInt32 isEqualItem)
{
...
UInt32 GASItemTransaction::GetItemNum(UInt32 id)
{
...
void GASItemTransaction::CheckItem()
{
...
void GASItemTransaction::RemoveItem(const std::string& reason)
{
...
void GASItemTransaction::UnLock()
{
