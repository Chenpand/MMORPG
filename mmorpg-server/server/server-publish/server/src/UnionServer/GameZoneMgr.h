...
public://消息相关
	 ...
	 *@brief 广播消息到World
	 */
	void BroadcastToGameZoneWorld(Avalon::Packet* packet);
	void BroadcastToGameZoneWorld(Avalon::Protocol& protocol);


	/**
	 *@brief 广播消息到Scene
	 */
	void BroadcastToGameZoneScene(Avalon::Packet* packet);
	void BroadcastToGameZoneScene(Avalon::Protocol& protocol);
