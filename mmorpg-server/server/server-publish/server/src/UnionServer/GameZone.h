...
public: //消息相关
	...
	*@brief 转发消息给玩家
	*/
	void SendToPlayer(ObjID_t playerId, Avalon::Packet* packet);
	void SendToPlayer(ObjID_t playerId, Avalon::Protocol& protocol);

	/**
	*@brief 转发消息给玩家
	*/
	void SendToScenePlayer(ObjID_t playerId, UInt32 sceneNodeId, Avalon::Packet* packet);
	void SendToScenePlayer(ObjID_t playerId, UInt32 sceneNodeId, Avalon::Protocol& protocol);
