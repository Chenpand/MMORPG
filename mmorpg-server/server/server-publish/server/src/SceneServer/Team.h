...
public:
	...
	*@brief 检测队伍能否开始比赛
	*/
	bool CanStartDungeonRace(UInt32 dungeonId, bool checkTicket, bool sendNotice, bool checkLoading, const SceneNpc& cityMonster, bool isTeamMatch = false);
...
public:
    ...
    */
	...
	bool HasFriend(Player *self) const;

	bool HasSameGuild(Player *self) const;
