...
Creature::Creature()
{
	REGISTER_SYNC_PROPERTY(m_Level, SOA_LEVEL, SST_SELF | SST_AROUND | SST_WATCH | SST_SCENE | SST_CHALLENGE | SST_TEST | SST_BATTLE | SST_LOSTDUNGEON)
	REGISTER_SYNC_PROPERTY(m_Sex, SOA_SEX, SST_SELF | SST_AROUND | SST_WATCH | SST_SCENE | SST_CHALLENGE | SST_TEST | SST_BATTLE | SST_LOSTDUNGEON)
	REGISTER_SYNC_PROPERTY(m_Status, SOA_STATUS, SST_TEST | SST_SELF | SST_AROUND | SST_SCENE | SST_CHALLENGE | SST_TEST | SST_BATTLE | SST_LOSTDUNGEON)

	REGISTER_SYNC_PROPERTY(m_MoveSpeed, SOA_MOVESPEED, SST_SELF | SST_AROUND | SST_CHALLENGE | SST_TEST | SST_BATTLE | SST_LOSTDUNGEON)

	REGISTER_SYNC_PROPERTY(m_SkillMgr, SOA_SKILLS, SST_SELF | SST_SKILLBUFF | SST_TEST)
	REGISTER_SYNC_PROPERTY(m_BuffMgr, SOA_BUFFS, SST_SELF | SST_SELECTED | SST_TEAM | SST_SKILLBUFF | SST_TEST)
