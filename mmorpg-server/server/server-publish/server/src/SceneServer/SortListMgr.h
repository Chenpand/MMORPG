...
public://事件
	...
	void OnSortEquipValueChanged(UInt8 sortType, ObjID_t id, const std::string& name, UInt8 quality, UInt8 occu,
		ObjID_t ownerId, UInt16 level, UInt32 value1, UInt32 value2, UInt32 value3, UInt8 equipType, UInt8 enhanceType);
