...
void PlayerMgr::RegisterProtocols()
{
	...
	SS_REGISTER_PROTOCOL(CLProtocol::SceneSetSkillPageReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneBuySkillPageReq)
	...
	SS_REGISTER_PROTOCOL(CLProtocol::SceneClientLog)
	...
	SS_REGISTER_PROTOCOL(CLProtocol::SceneEquipEnhanceUpgrade)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneEquipEnhanceClear)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneEquipEnhanceRed)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneEquipEnhanceChg)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneEnhanceMaterialCombo)
 	SS_REGISTER_PROTOCOL(CLProtocol::SceneEquipDecompose)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneEquieUpdateReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneItemDepositReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneItemDepositGetReq)
	...
	SS_REGISTER_PROTOCOL(CLProtocol::SceneNewSignIn)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneNewSignInQuery)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneNewSignInCollect)
	...
	SS_REGISTER_PROTOCOL(CLProtocol::SceneSetEqualPvpSkillConfigReq)
	...
	SS_REGISTER_PROTOCOL(CLProtocol::SceneReportNotify)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneShortcutKeySetReq)
	...
	SS_REGISTER_PROTOCOL(CLProtocol::SceneCreditPointRecordReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneSecretCoinReq)
	...
	SS_REGISTER_PROTOCOL(CLProtocol::SceneDungeonZjslRefreshBuffReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneDungeonZjslClearGetAwardReq)
	...
	//WarpStone
	SS_REGISTER_PROTOCOL(CLProtocol::SceneWarpStoneUnlockReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneWarpStoneChargeReq)
	...
	SS_REGISTER_PROTOCOL(CLProtocol::SceneWeekSignRewardReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneOpActivityAcceptTaskReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneOpActivityGetCounterReq)
	...
	//ScoreWar
	SS_REGISTER_PROTOCOL(CLProtocol::SceneScoreWarRewardReq)
	SS_REGISTER_PROTOCOL(CLProtocol::Scene2V2ScoreWarRewardReq)
	...
	//宝珠转换
	SS_REGISTER_PROTOCOL(CLProtocol::SceneBeadConvertReq);
	...
	//附魔卡
	SS_REGISTER_PROTOCOL(CLProtocol::SceneMagicCardUpgradeReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneMagicCardCompOneKeyReq)

	//铭文
	SS_REGISTER_PROTOCOL(CLProtocol::SceneEquipInscriptionOpenReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneEquipInscriptionMountReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneEquipInscriptionExtractReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneEquipInscriptionSynthesisReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneEquipInscriptionDestroyReq)
	
	//限定商城
	SS_REGISTER_PROTOCOL(CLProtocol::SceneMallFashionLimitedSuitStatusReq);
	//挑战者积分
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChallengeScoreReq);

	//装备方案
	SS_REGISTER_PROTOCOL(CLProtocol::SceneEquipSchemeWearReq);

	// 荣誉
	SS_REGISTER_PROTOCOL(CLProtocol::SceneHonorReq);

	// 装备转换
	SS_REGISTER_PROTOCOL(CLProtocol::SceneEquipConvertReq);

	// 植树节种树请求
	SS_REGISTER_PROTOCOL(CLProtocol::SceneActivePlantReq);
	// 植树节鉴定请求
	SS_REGISTER_PROTOCOL(CLProtocol::SceneActivePlantAppraReq);

	//设置招募红点
	SS_REGISTER_PROTOCOL(CLProtocol::SceneQueryHireRedPointReq);
	


	// 冠军赛
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionEnrollReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionReliveReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionReliveRes);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampion16TableReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionGambleReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionObserveReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionStatusReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionTotalStatusReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionSelfStatusReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionSelfBattleRecordReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionGroupRankReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionGroupRecordReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionJoinPrepareReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionScoreBattleRecordsReq);
	SS_REGISTER_PROTOCOL(CLProtocol::UnionChampionReliveRes);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionAllGambleInfoReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionGambleRecordReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionAllGroupReq);
	SS_REGISTER_PROTOCOL(CLProtocol::SceneChampionGmableAlreadyBetReq);




	SS_REGISTER_PROTOCOL(CLProtocol::SceneWeaponBuildReq);

	// 金币寄售
	SS_REGISTER_PROTOCOL(CLProtocol::SceneGoldConsignmentSubmitOrderReq);
	SS_REGISTER_PROTOCOL(CLProtocol::UnionPlayerGetItem);
	
	// 迷失地牢
	// 挑战战场
	SS_REGISTER_PROTOCOL(CLProtocol::LostDungeonChallengeReq);
	// 开启爬塔 
	SS_REGISTER_PROTOCOL(CLProtocol::LostDungeonOpenReq);

	SS_REGISTER_PROTOCOL(CLProtocol::SceneUnlockRoleStorageReq);
	SS_REGISTER_PROTOCOL(CLProtocol::LostDungeonOpenBoxReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneLostDungeonBoxChoiceItemReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneLostDungeonGetRewardReq)
	SS_REGISTER_PROTOCOL(CLProtocol::SceneLostDungeonGiveUpReq)
