...
struct stKillNpcEvent : public TaskScriptEventBase //击杀怪物的事件
{
...
struct StrengthenEquipEvent : public TaskScriptEventBase	//强化事件
{
...
public:
	...
	*/
	...
	/**
	*@brief 穿戴时装事件  adder by huchenhui 2018.03.20
	*/
...
public: //脚本事件
	...
	*/
	...
	/**
	 *@brief 地下城(副本)通关后的回调. dungeonId - 地下城id(包含难度信息), score - 评分
	 */
