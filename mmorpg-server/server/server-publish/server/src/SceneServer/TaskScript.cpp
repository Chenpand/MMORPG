...
void TaskScript::BindGetItemEvent(UInt32 id, UInt8 quality, UInt8 strengthen)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(gievent, *this);
}
...
void TaskScript::BindKillNpcEvent(UInt32 id, UInt32 dungeon)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(event, *this);
}
...
void TaskScript::BindKillCityMonsterEvent(CityMonsterType cityMonsterType, UInt32 monsterId)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(killCityMonsterEvent, *this);
}
...
void TaskScript::BindRemakeEquipEvent(UInt32 id, UInt8 type)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(remakeEvent, *this);
}
...
void TaskScript::BindStrengthenEquipEvent(bool isSuccess, UInt8 strengthen)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(m_StrengthenEquipEvent, *this);
}
...
void TaskScript::BindPutEquipEvent(UInt16 level, UInt8 color, UInt32 strengthen)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(putEquipEvent, *this);
}
...
void TaskScript::BindPutFashionEvent(ItemSubType subType, UInt8 color, UInt8 isTransparent)
{
	PutFashionEvent putFashionEvent(subType, color, isTransparent);
	m_PutFashionEvents.push_back(putFashionEvent);

	ScriptMgr::Instance()->RegisterScriptEvent(putFashionEvent, *this);
}

bool TaskScript::CheckPutFashionEvent(ItemSubType subType, UInt8 color, UInt8 isTransparent) const
{
	for (PutFashionEventList::const_iterator iter = m_PutFashionEvents.begin(); iter != m_PutFashionEvents.end(); ++iter)
	{
		if (iter->color <= color
			...
			&& (iter->isTransparent == 0 || iter->isTransparent == isTransparent))
		{
			return true;
		}
	}
...
void TaskScript::BindRetinueUpLevelSkillEvent(UInt32 id, UInt8 level)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(rulEvent, *this);
}
...
void TaskScript::BindCopyScenePassedEvent(UInt32 dungeonId, LevelScore score, UInt32 usedTime, UInt32 reviveCount)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(cdEvent, *this);
}
...
void TaskScript::BindSubmitActiveTaskSucceedEvent(UInt32 templateId, UInt32 taskId)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(atEvent, *this);
}
...
void TaskScript::BindPVPEvent(PkType type, PkRaceResult raceResult)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(pEvent, *this);
}
...
void TaskScript::BindOpenMagicJarEvent(JarType type, UInt32 combo)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(omjEvent, *this);
}
...
void TaskScript::BindWarpStoneUpLevelEvent(WarpStoneType type, UInt32 level)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(wsulEvent, *this);
}
...
void TaskScript::BindShopBuyEvent(UInt32 shopId, UInt32 itemId)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(sbEvent, *this);
}
...
void TaskScript::BindClearHellEvent(UInt32 id, UInt32 usedTime, LevelScore score)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(hellEvent, *this);
}
...
void TaskScript::BindDeathTowerEvent(UInt32 towerId, UInt32 layer, UInt32 usedTime)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(dtEvent, *this);
}
...
void TaskScript::BindSetTaskItemEvent(ItemQuality quality, UInt32 level)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(taskItemEvent, *this);
}
...
void TaskScript::BindFeedPetEvent(PetFeedType type)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(fpEvent, *this);
}
...
void TaskScript::BindAddPetEvent(PetType petType, PetQuality petQuality)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(addPetEvent, *this);
}
...
void TaskScript::BindPetUpLevelEvent(PetType petType, PetQuality petQuality, UInt16 level)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(petUpLevelEvent, *this);
}
...
void TaskScript::BindAddRelationEvent(RelationType type)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(relationEvent, *this);
}
...
void TaskScript::BindCalculateEquipScoreEvent(ItemSubType subType, ItemQuality quality, UInt32 score)
{
	...
	ScriptMgr::Instance()->RegisterScriptEvent(equitScoreEvent, *this);
}
...
void TaskScript::BindClearTeamCopyEvent()
{
	m_bClearTeamCopyEvent = true;
}

bool TaskScript::CheckClearTeamCopyEvent()
{
	return m_bClearTeamCopyEvent;
}
...
void TaskScript::OnClearTeamCopy(Player* player, BaseTask* task, UInt32 teamType, UInt32 grade, UInt32 costTime)
{
	if (task)
	{
		Call<void>("OnClearTeamCopy", player, task, teamType, grade, costTime);
	}
}