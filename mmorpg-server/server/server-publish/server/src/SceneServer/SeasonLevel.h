...
class SeasonUplevelBattle : public CLOwnerComplexProperty
{
public:
	SeasonUplevelBattle(){};
	~SeasonUplevelBattle(){};
...
public:
	...
	*@brief 获取赛季段位
	*/
	OwnerObjUInt32& GetSeasonLevel() { return m_SeasonLevel; }

	/**
	*@brief 获取赛季星级
	*/
	OwnerObjUInt32& GetSeasonStar() { return m_SeasonStar; }

	/**
	*@brief 获取赛季经验
	*/
	OwnerObjUInt32& GetSeasonExp() { return m_SeasonExp; }
	...
	*@brief 获取赛季属性id
	*/
	OwnerObjUInt8& GetSeasonAttr() { return m_SeasonAttr; }

	/**
	*@brief 获取王者印记
	*/
	OwnerObjUInt16& GetSeasonKingMarkCount() { return m_SeasonKingMarkCount; }
...
private:
	...
	// 赛季段位
	OwnerObjUInt32		m_SeasonLevel;

	// 赛季星级
	OwnerObjUInt32		m_SeasonStar;

	// 赛季经验
	OwnerObjUInt32		m_SeasonExp;
	...
	//赛季属性id
	OwnerObjUInt8			m_SeasonAttr;

	//赛季属性结束时间
	ObjUInt32			m_ChangeSeasonAttrTime;

	//王者印记
	OwnerObjUInt16			m_SeasonKingMarkCount;
