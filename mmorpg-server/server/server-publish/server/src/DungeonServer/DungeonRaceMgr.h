...
public:
	...
	*/
	...
	HashMap<UInt64, DungeonRace*>& GetRaces() { return  m_dungeones; }
private:
    UInt64 GenDungeonRaceID();

private:
    // 当玩家离开地下城，地下城数据的保存时间
    const UInt32                    TIME_TO_WAIT_CLOSE_WHEN_PLAYER_LEAVE = 1 * Avalon::Time::SECS_OF_MIN * Avalon::Time::MSECS_OF_SEC; 
