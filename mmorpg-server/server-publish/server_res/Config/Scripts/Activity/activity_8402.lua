...
function AddReward(player)
	  ...
	  local giftpack = {} 
		if job == 5 then
			giftpack = {item1 = {id=800000105,num=1}, 
			item2 = {id=230000946,num=1}, item3 = {id=800000102,num=1}}		
		elseif job == 1 then
			giftpack = {item1 = {id=800000105,num=1}, 
			item2 = {id=230000946,num=1}, item3 = {id=800000102,num=1}}
		elseif job == 3 then
			giftpack = {item1 = {id=800000105,num=1}, 
			item2 = {id=230000957,num=1}, item3 = {id=800000102,num=1}}	
		elseif job == 2 then
			giftpack = {item1 = {id=800000105,num=1}, 
			item2 = {id=230000946,num=1}, item3 = {id=800000102,num=1}}
		end
		...
		player:AddRewards("16003;8402;0", group, true)
		return true
end