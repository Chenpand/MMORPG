function OnUseSelf(player, item)
	local reason="2012;800000034;0"
	local giftpack = {item1 = {id=200050001,num=1}, item2 = {id=200050005,num=1},
				   item3 = {id=200050009,num=1}, item4 = {id=200050013,num=1},
                   item5 = {id=200050017,num=1}} 
