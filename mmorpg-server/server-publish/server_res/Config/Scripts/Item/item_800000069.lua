function OnUseSelf(player, item)
	...
	local reason="2012;800000069;0"
	if job == 1 then
		local giftpack = {item1 = {id=121071001,num=1}, item2 = {id=121070001,num=1}, item3 = {id=121073001,num=1}}
	...
	elseif job == 5 then
		local giftpack = {item1 = {id=121051001,num=1}, item2 = {id=121050001,num=1}, item3 = {id=121053001,num=1}}
		local group = player:GetRewardGroup()
		for k,v in pairs(giftpack) do
			group:AddReward(v.id, v.num)
		end	
	...
	elseif job == 3 then
		local giftpack = {item1 = {id=121041001,num=1}, item2 = {id=121040001,num=1}, item3 = {id=121043001,num=1}}
		local group = player:GetRewardGroup()
		for k,v in pairs(giftpack) do
			group:AddReward(v.id, v.num)
		end	
