function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(153, 305000)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(153, 305001)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(153, 305002)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(153, 305003)	 -- 关注杀死指定怪物事件
