function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(115, 506000)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(115, 506001)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(115, 506002)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(115, 506003)	 -- 关注杀死指定怪物事件
