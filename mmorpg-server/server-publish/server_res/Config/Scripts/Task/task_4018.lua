function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(0, 207000)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(0, 207001)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(0, 207002)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(0, 207003)	 -- 关注杀死指定怪物事件
end
