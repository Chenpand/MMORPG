function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(122, 501020)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(122, 501021)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(122, 501022)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(122, 501023)	 -- 关注杀死指定怪物事件
