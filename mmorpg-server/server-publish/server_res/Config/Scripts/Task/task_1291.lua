function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(127, 501000)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(127, 501001)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(127, 501002)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(127, 501003)	 -- 关注杀死指定怪物事件
