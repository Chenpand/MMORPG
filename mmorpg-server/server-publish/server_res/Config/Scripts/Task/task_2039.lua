function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(110, 301020)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(110, 301021)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(110, 301022)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(110, 301023)	 -- 关注杀死指定怪物事件
