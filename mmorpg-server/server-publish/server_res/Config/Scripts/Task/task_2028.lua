function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(103, 206020)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(103, 206021)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(103, 206022)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(103, 206023)	 -- 关注杀死指定怪物事件
