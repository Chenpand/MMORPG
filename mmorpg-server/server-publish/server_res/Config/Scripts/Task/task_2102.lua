function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(127, 504020)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(127, 504021)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(127, 504022)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(127, 504023)	 -- 关注杀死指定怪物事件
