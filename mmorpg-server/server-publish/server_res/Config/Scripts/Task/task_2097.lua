function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(151, 503020)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(151, 503021)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(151, 503022)	 -- 关注杀死指定怪物事件
	task:BindKillNpcEvent(151, 503023)	 -- 关注杀死指定怪物事件
