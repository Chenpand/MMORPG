function Init(task)				---绑定(注册)该任务需要关注的事件
	task:BindKillNpcEvent(101, 102010)	-- 关注杀死指定怪物事件
	task:BindKillNpcEvent(101, 102011)	-- 关注杀死指定怪物事件
	task:BindKillNpcEvent(101, 102012)	-- 关注杀死指定怪物事件
	task:BindKillNpcEvent(101, 102013)	-- 关注杀死指定怪物事件
end
